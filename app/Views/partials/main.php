...
<body class="hold-transition layout-top-nav">
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Aplikasi Iuran Kas Rt <small></small></h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
        ...
        <footer class="main-footer">
            ...
            <!-- Default to the left -->
            <strong>Copyright &copy; <?= date('Y') ?> <a href="https://github.com/sardin311002/iuran_kasRT_ganjil">Din31</a>.</strong> All rights
            reserved.
        </footer>
    </div>
    <!-- ./wrapper -->
